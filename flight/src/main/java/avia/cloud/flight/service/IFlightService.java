...
public interface IFlightService {
    List<FlightDTO> searchFlights(String origin, String destination, boolean oneWay, LocalDate date, Cabin cabin, Currency currency, double minPrice, double maxPrice);
}
